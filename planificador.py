...
class Planificador():
    def __init__(self, planner_path, domain_path, problem_path, output_path, print=False):
    ...
    def run_plan(self):
        ...
        try:
            os.system(f'./{self.planner_path} -o {self.domain_path} -f {self.problem_path} -S 1 -O > {self.output_path}')
