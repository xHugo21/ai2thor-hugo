...
countertop_8 - countertop
countertop_9 - countertop
countertop_10 - countertop
countertop_11 - countertop
countertop_12 - countertop
countertop_13 - countertop
...
sidetable_2 - sidetable
sidetable_3 - sidetable
...
(close_to countertop_16)
(close_to countertop_17)
(close_to countertop_17)
(close_to countertop_18)
(close_to countertop_18)
(close_to countertop_19)
(close_to countertop_19)
(close_to cup_0)
(close_to cup_0)
(close_to knife_0)
...
(discovered countertop_10)
(discovered countertop_11)
(discovered countertop_12)
(discovered countertop_13)
...
(inspected countertop_11)
(inspected countertop_12)
(inspected countertop_13)
(inspected countertop_14)
(inspected countertop_15)
(inspected countertop_18)
(inspected countertop_19)
...
(inspected stoveburner_3)
(inspected stoveknob_0)
(inspected stoveknob_1)
(inspected toaster_0)
(inspected winebottle_0)
(on houseplant_1 sinkbasin_0)
(on winebottle_0 sidetable_4)
(open cabinet_6)
(open kettle_0)
(open microwave_0)
(open microwave_1)
...
(pickupable spoon_0)
(pickupable winebottle_0)
(receptacle bowl_0)
(receptacle cabinet_6)
(receptacle coffeemachine_0)
(receptacle countertop_0)
(receptacle countertop_1)
(receptacle countertop_10)
(receptacle countertop_11)
(receptacle countertop_12)
(receptacle countertop_13)
...
(receptacle sidetable_2)
(receptacle sidetable_3)
...
(viewing cabinet_6)
(viewing countertop_20)
(viewing fork_0)
(viewing kettle_0)
(viewing knife_0)
(viewing microwave_0)
(viewing peppershaker_0)
(viewing saltshaker_0)
(viewing spatula_0)
(viewing spoon_0)
(viewing stoveburner_0)
(viewing stoveburner_1)
(viewing stoveburner_2)
(viewing stoveburner_3)
(viewing stoveknob_0)
(viewing stoveknob_1)
)
(:goal
(and
(exists (?o1 - cabinet) (and (viewing ?o1) (close_to ?o1))))
))